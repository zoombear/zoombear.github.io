...
(function() {
  ...
  collect = function() {
    var data, getAttrib, getContext, getContextByName, getEndian, getExtensions, getParams, getShaderPrecisions, getWebglInfo, isPresent, paramNames, request, vendorName, vendors;
